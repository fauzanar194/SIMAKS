...
class Cetak extends CI_Controller{
    ...
    function cetak_laporan($id){
      ...
      $pdf = new FPDF('p','mm','A4');
       ...
       $pdf->Cell(189, 7, 'Sistem Informasi Manajemen Keuangan Sekolah', 0, 1, 'C');
       $pdf->SetFont('TIMES','B',16);
       $pdf->Cell(192, 7, 'Universitas Negeri Surabaya', 0, 1, 'C');
       $pdf->SetFont('TIMES','',12);
       $pdf->Cell(189, 5, 'Jl. Ketintang Kec. Gayungan, Surabaya', 0, 1, 'C');
       $pdf->Cell(189, 5, 'Telp.(020) 0000000,Fax(020)0000000', 0, 1, 'C');
       $pdf->Cell(189, 5, 'E-mail : admin@gmail.com', 0, 1, 'C');
       $pdf->SetLineWidth(1);
...
foreach($data['pengeluaran'] as $r){
       ...
       $pdf->Cell(125, 35, '', 0, 1);
       $pdf->Cell(125, 35, '', 0, 0);
       $pdf->Cell(55, 5, 'Ketintang, '.  tanggal(waktu(),'bulan'), 0, 1);
       $pdf->Cell(125, 5, '', 0, 0);
