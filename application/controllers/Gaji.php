...
class Gaji extends CI_Controller {
	...
	function index(){
		...
		$this->breadcrumb->append_crumb('SIMAKS','Beranda');
		$this->breadcrumb->append_crumb($this->parents.' Guru',$this->parents);

		$data['title']	= 'Pembayaran '.$this->parents.' | SIMAKS';
